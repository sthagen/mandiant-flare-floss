...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("adaptivestackstart", 0x12944, StringEncoding.UTF8, "go_strings32"),
        # .data:00534944 A0 35 4A 00                       dd offset aAdaptivestacks ; "adaptivestackstart"
        # .data:00534948 12                                db  12h
        pytest.param("adaptivestackstart", 0x15568, StringEncoding.UTF8, "go_strings64"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("comparing uncomparable type ", 0x2276, StringEncoding.UTF8, "go_strings32"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("ExpandEnvironmentStringsW", 0x80211, StringEncoding.UTF8, "go_strings64"),
